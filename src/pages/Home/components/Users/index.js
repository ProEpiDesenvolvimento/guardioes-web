      ...
      >
        ...
        <form id="editUser" onSubmit={handleSubmit(_editUser)}>
          ...
          <ModalInput
            ...
            setValue={(e) => handleEditBirthdate(e)}
          />
      ...
      >
        ...
        <form id="filterUser" onSubmit={handleSubmit(() => getSearch(1))}>
          ...
          <ModalInput
            ...
            setValue={(e) => setFilteringUser({ ...filteringUser, email: e })}
          />
          ...
          <ModalInput
            ...
            setValue={(e) => setFilteringUser({ ...filteringUser, user_name: e})}
          />
          ...
          <ModalInput
            ...
            options={genderChoices}
            setValue={(e) => setFilteringUser({ ...filteringUser, gender: e })}
          />
          ...
          <ModalInput
            ...
            options={raceChoices}
            setValue={(e) => setFilteringUser({ ...filteringUser, race: e })}
          />
          ...
          <ModalInput
            ...
            setValue={e => setFilteringUser({ ...filteringUser, country: e })}
          />
          ...
          <ModalInput
            ...
            options={[
              { key: true, label: "Sim" },
              { key: false, label: 'Não' }]}
            setValue={(e) => setFilteringUser({ ...filteringUser, is_professional: e })}
          />
            ...
            {user.type === "group_manager" ?
              ...
              <ModalInput
                ...
                setValue={(e) => setFilteringSuffix({ ...filteringSuffix, identification_code: e })}
              />
              <ModalInput
                type="text"
                ...
                setValue={(e) => setFilteringUser({ ...filteringUser, identification_code: e})}
              />
              </> : null
            }
          </Modal.Body>
