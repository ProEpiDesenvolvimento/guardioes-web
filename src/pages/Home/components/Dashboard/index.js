...
function Dashboard(props) {
  ...
  return (
    <Container style={ style.headerContainer }>
      <i>NOTA: caso você encontre problemas nessa página, use o navegador Firefox</i>
      <Container>
          <div style={style.headerContainer}>
            <h3 style={style.header}>Dados gerais</h3>
          </div>
          <iframe 
        ...
        <Container>
          <div style={style.headerContainer}>
            <h3 style={style.header}>Dados sobre adesão</h3>
          </div>
          <iframe 
        ...
        <Container>
          <div style={style.headerContainer}>
            <h3 style={style.header}>Tabelas de dados</h3>
          </div>
          <iframe 
