    ...
    <Container style={style.headerContainer}>
      <ul className="nav nav-tabs justify-content-center" style={{marginTop: 20}}>
        <li className="nav-item">
          <a className={`nav-link ${isCurrentNav('geral') ? 'active' : null}`} href="#geral">Dados gerais</a>
        </li>
        <li className="nav-item">
          <a className={`nav-link ${isCurrentNav('adesao') ? 'active' : null}`} href="#adesao">Dados sobre adesão</a>
        </li>
        <li className="nav-item">
          <a className={`nav-link ${isCurrentNav('dados') ? 'active' : null}`} href="#dados">Tabelas de dados</a>
        </li>
      </ul>

      <Container show={isCurrentNav('geral')}>
        <iframe
          title="Dados gerais"
      ...
      <Container show={isCurrentNav('adesao')}>
        <iframe
      ...
      <Container show={isCurrentNav('dados')}>
        <iframe
      ...
      <i style={{margin: 20}}>NOTA: caso você encontre problemas nessa página, use o navegador Firefox</i>
    </Container>
  );
}
